...
class PaymentFlowIntegrationTest {
    ...
    void exposesOpenApiDocumentationAndSwaggerUi() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/merchant/webhook-events']").exists())
                .andExpect(jsonPath("$.paths['/api/merchant/webhook-events/summary']").exists())
                .andExpect(jsonPath("$.paths['/api/merchant/webhook-events/{eventId}']").exists())
                .andExpect(jsonPath("$.paths['/api/merchant/webhook-events/{eventId}/deliveries']")
                        .exists())
